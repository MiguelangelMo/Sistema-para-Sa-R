              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <select v-model="idrol" class="form-control">
                    <option value="0" selected>Seleccionado</option>
                    <option
  ...
  methods: {
    listarPersona(page, buscar, criterio) {
      ...
      axios
        ...
        .then(function(response) {
          ...
          me.arrayPersona = respuesta.user.data;
    ...
    desactivarUsuario(id) {
      ...
      swalWithBootstrapButtons
        .fire({
          title: "¿Esta Seguro de Desactivar la Usuario?",
          type: "warning",
    ...
    activarUsuario(id) {
      ...
      swalWithBootstrapButtons
        .fire({
          title: "¿Esta Seguro de Activar la Usuario?",
          type: "warning",
          showCancelButton: true,
          confirmButtonText: "Si lo estoy!",
          cancelButtonText: "No lo estoy!",
